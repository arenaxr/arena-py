...
def make_sign():
    ...
    button = GLTF(
        object_id="button",
        position=(sign_x,sign_y-.25,sign_z+1),
        scale=(1.0,1.0,1.0),
    ...
    slide1_material = Material(flatShading="true",src="https://www.dropbox.com/s/3hccefrz6ywlknh/slide1.png?dl=0")
    slide1 = Box( 
        object_id="slide1", 
    ...
    slide2_material = Material(flatShading="true",src="https://www.dropbox.com/s/xvh920h7zqeqaqd/slide2.png?dl=0")
    slide2 = Box( 
        object_id="slide2", 
    ...
    slide3_material = Material(flatShading="true",src="https://www.dropbox.com/s/krxk5n4kxetaxcd/slide3.png?dl=0")
