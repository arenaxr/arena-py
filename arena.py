...
class cube:
  ...
  def location(self, loc):
    ...
    client.publish(scene_path+"/cube_"+self.objName,'{"object_id": "cube_'+self.objName+'", "position": {'+draw_str+'}}',retain=False) 
  ...
  def redraw(self):
    ...
    client.publish(scene_path+"/cube_"+self.objName,json.dumps(MESSAGE),retain=False)  
