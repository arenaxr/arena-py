...
while (True):
    ...
    MESSAGE='{"object_id" : "'+name+'", "action": "create", "ttl": 40, "data": {"dynamic-body": {"type": "dynamic"}, "object_type": "'+"sphere"+'", "position": {"x": '+randy() +', "y": '+"{0:0.3f}".format(0) +', "z": '+randy() +'}, "rotation": {"x": '+randrot() +', "y": '+ randrot()+', "z": '+randrot() +', "w": '+randrot() +'}, "color": "#'+randcolor()+'"}}'
