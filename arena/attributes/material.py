...
class Material(Attribute):
    ...
    :param float alphaTest: Alpha test threshold for transparency. Defaults to '0' (optional)
    :param float anisotropy: The anisotropic filtering sample rate to use for the textures. A value of 0 means the default value will be used, see renderer. Defaults to '0' (optional)
    ...
    :param bool flatShading: Use THREE.FlatShading rather than THREE.StandardShading. Defaults to 'False' (optional)
    ...
    :param float metalness: How metallic the material is from 0 to 1. Requires `shader: standard`. Defaults to '0' (optional)
    :param bool npot: Use settings for non-power-of-two (NPOT) texture. Defaults to 'False' (optional)
    ...
    :param bool refract: Whether the defined envMap should refract. Requires `shader: phong`. Defaults to 'False' (optional)
    :param float refractionRatio: refractionRatio Defaults to '0.98' (optional)
    :param dict repeat: How many times a texture (defined by src) repeats in the X and Y direction. Defaults to '{'x': 1, 'y': 1}' (optional)
    :param float roughness: How rough the material is from 0 to 1. A rougher material will scatter reflected light in more directions than a smooth material. Requires `shader: standard`. Defaults to '0' (optional)
    ...
    :param bool transparent: Whether material is transparent. Transparent entities are rendered after non-transparent entities. Defaults to 'False' (optional)
    :param bool vertexColorsEnabled: Whether to use vertex or face colors to shade the material. Defaults to 'False' (optional)
    ...
    :param bool wireframe: Whether to render just the geometry edges. Defaults to 'False' (optional)
