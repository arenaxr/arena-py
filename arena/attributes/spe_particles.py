...
class SpeParticles(Attribute):
    ...
    :param list angle: 2D rotation of the particle over the particle's lifetime, max 4 elements; defaults to '[0]' (optional)
    :param list angleSpread: spread in angle over the particle's lifetime, max 4 elements; defaults to '[0]' (optional)
    ...
    :param list color: array of colors over the particle's lifetime, max 4 elements; defaults to '['#fff']' (optional)
    :param list colorSpread: spread to apply to colors, spread an array of vec3 (r g b) with 0 for no spread. note the spread will be re-applied through-out the lifetime of the particle (optional)
    ...
    :param list opacity: opacity over the particle's lifetime, max 4 elements; defaults to '[1]' (optional)
    :param list opacitySpread: spread in opacity over the particle's lifetime, max 4 elements; defaults to '[0]' (optional)
    ...
    :param list size: array of sizes over the particle's lifetime, max 4 elements; defaults to '[1]' (optional)
    :param list sizeSpread: spread in size over the particle's lifetime, max 4 elements; defaults to '[0]' (optional)
