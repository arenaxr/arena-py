...
class Animation(Attribute):
    ...
    :param list pauseEvents: Comma-separated list of events to listen to trigger pause. Can be resumed with resumeEvents. (optional)
