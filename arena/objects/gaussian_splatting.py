...
class GaussianSplatting(Object):
    ...
    :param str cutoutEntity: Selector to a box primitive that uses scale and position to define the bounds of splat points to render. Defaults to '' (optional)
    ...
    :param str src: Url of the .ply or .splat file. Use File Store paths under 'store/users/username', see CDN and other storage options in the description above. (optional)
