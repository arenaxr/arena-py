...
class Sound(Attribute):
    ...
    :param bool autoplay: Whether to automatically play sound once set. Defaults to 'False' (optional)
    :param str distanceModel: Sound model. Allows [linear, inverse, exponential] Defaults to 'inverse' (optional)
    :param bool loop: Whether to loop the sound once the sound finishes playing. Defaults to 'False' (optional)
