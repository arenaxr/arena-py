...
class ProgramRunInfo(BaseObject, GetPublicAttrsMixin):
    ...
    def __init__(self, evt_loop=None, queue_len_callable=None, update_callback=None, update_interval_ms=_get_env(PROGRAM_STATS_UPDATE_INTERVAL_MS), **kwargs):
        ...
        :param object update_callback: callback when stats are updated (optional).
        :param int update_interval_ms: interval of the periodic task to update program stats (optional).
        :param object kwargs: additional attributes to add to the program info, e.g. web host, scene, namespace (optional).
        """
