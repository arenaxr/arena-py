...
from ..env import ARENA_TELEMETRY, OTLP_ENDPOINT, _get_env
...
class ArenaTelemetry():
    ...
    def __init__(self, name=sys.argv[0], id=None):
        """ Return an `ArenaTelemetry` using given service name and id.
            ...
            :param str name: name of the service used with the telemetry backend (required).
            :param str id: additional id used with the telemetry backend (optional).
        """
