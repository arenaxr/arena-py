...
export REALM=realm
"""
# but can also specify as arguments like below:
...
def main(arg):
    ...
    # be careful about usinf time.sleep(), it will block all other tasks.
    # I use it here because I only run one task
    time.sleep(2)
    ...
    text = Text(object_id="text", text="Hope you enjoyed!", position=Position(0,1,0), parent=cube)
    arena.add_object(text)
...
arena.run_once(main, "Hi, I am an argument")
arena.start_tasks()
