...
def signal_handler(sig, frame):
  client.publish(scene_path+object_name,'{"object_id": "'+object_name+'", "action": "delete"}',retain=True)
...
def on_click_input(client, userdata, msg):
    ...
    if jsonMsg["type"]!="mousedown" and jsonMsg["type"]!="mouseup": return
    ...
    client.publish(scene_path+object_name,json.dumps(MESSAGE)) #cube_str.format(x,y,z))
