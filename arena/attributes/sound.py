...
class Sound(Attribute):
    ...
    :param str distanceModel: Sound model: linear, inverse, or exponential. [linear, inverse, exponential]; defaults to 'inverse' (optional)
    ...
    :param str on: An event for the entity to listen to before playing sound. [mousedown, mouseup, mouseenter, mouseleave, triggerdown, triggerup, gripdown, gripup, menudown, menuup, systemdown, systemup, trackpaddown, trackpadup]; defaults to 'mousedown' (optional)
