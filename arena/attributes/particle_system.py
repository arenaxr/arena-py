...
class ParticleSystem(Attribute):
    ...
    :param list[str] color: Describes a particle's color. This property is a 'value-over-lifetime' property, meaning an array of values can be given to describe specific value changes over a particle's lifetime.; defaults to '['#0000FF', '#FF0000']' (optional)
    ...
    :param list[float] opacity: Either a single number to describe the opacity of a particle.; defaults to '[1]' (optional)
    :param list[float] opacitySpread: ; defaults to '[1]' (optional)
    ...
    :param list[float] size: Describes a particle's size.; defaults to '[1]' (optional)
    :param list[float] sizeSpread: ; defaults to '[0]' (optional)
