...
class Data(Attribute):
    ...
    :param str submodel_parent: When this object is parented to a hierarchical model, attaches to a named subcomponent of that model instead of the root position Defaults to '' (optional)
