...
class Cone:
    ...
    :param str object_type: 3D object type.. Must be 'cone'.
    :param float height: height. Defaults to 1
    :param bool openEnded: open ended, optional. Defaults to False
    :param float radiusBottom: radius bottom. Defaults to 1
    :param float radiusTop: radius top. Defaults to 0.01
